...
\section{Votes}
All issues requiring a vote, except when otherwise specified as a \textbf{Vote of the Membership} in these bylaws or required by law, shall be decided by affirmative vote of \textbf{more than one half (50\%)} of the \textbf{Members} present at any \textbf{Meeting}.
...
\item All \textbf{Votes of the Membership} shall require an affirmative vote of \textbf{more than half} of the \textbf{Members} voting, unless a higher threshold is specified for a particular vote.
\end{enumerate}
