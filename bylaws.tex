...
\begin{enumerate}
    ...
    to a member of the board of directors or an officer.
        ...
        \item abiding by our Code of Conduct, as detailed in the Code of Conduct
        Addendum, located in the Canonical Copy of Bylaws and Addenda under the name
        ‘code-of-conduct-addendum’, which is subject to approval of the membership
        by quorum vote.
    \end{enumerate}
\end{enumerate}
