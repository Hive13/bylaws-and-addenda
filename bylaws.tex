...
\subsection{Voting}
\begin{enumerate}
\item All issues requiring a vote, except when otherwise specified as a \textbf{Vote of the Membership} in these bylaws or required by law, shall be decided by affirmative vote of \textbf{more than one half (50\%)} of the \textbf{Members} present at any \textbf{Meeting}.
...
\item All \textbf{Votes of the Membership} shall require an affirmative vote of \textbf{more than half} of the \textbf{Members} voting, unless a higher threshold is specified for a particular vote in the Bylaws.
\end{enumerate}
\subsection{Remote Voting}
A poll may be brought up online to handle collection of votes as long as the online voting system authenticates users as \textbf{Members}. Once the poll has been announced to the \textbf{Membership}, there will be a period of no less than \textbf{seven (7) days} to vote on the topic. After the deadline, the online poll is locked so no further votes are possible and the results are included with other voting methods described within the Bylaws.
