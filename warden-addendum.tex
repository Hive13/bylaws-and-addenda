...
COO is responsible for proposing appointments and removal of area wardens to be decided by
majority vote of the Board of Directors. Additionally, the COO and head warden are responsible
for purchase and approval of funding for consumables/replacements from the warden budget
allocated by the membership. Short monthly progress meetings will be held with wardens.
\section{Budget}
...
approval and reimbursement to the COO and head warden.
\section{Compensation}
Area wardens can choose to be compensated 50\% of dues for full members and 100\% of
dues for student members (one dollar for accounting purposes). Current Officers and
Directors may not receive Compensation as Wardens.
...
\item Provide documentation and certification classes on major tools in area.
\item Consumables/parts are replenished through the warden budget.
\item Hold public open shop hours at least once a month at which the warden is presenti for 3-4 hours if members want to learn or receive help on a particular machine in their ward.
...
\item Head warden (not a separate warden, comes from current wardens)
\end{itemize}
\end{document}  
